...
{	
    public partial class T_EmployeetypeController : BaseController
    {
	 ...
	 ViewBag.T_AssociatedEmployeeTypeCount = t_employeetype.t_associatedemployeetype.Count();
        }
	...
	break;
        ...
        public JsonResult GetValidateBeforeSaveProperties(T_Employeetype OModel, string ruleType)
        {
            ...
            if (User.businessrules != null)
            {
                ...
                if (BR != null && BR.Count > 0)
                {
                    var ResultOfBusinessRules = db.ValidateBeforeSavePropertiesRule(OModel, BR, "T_Employeetype");
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
		...
		public string CheckBeforeSave(T_Employeetype t_employeetype)
        {
			var AlertMsg = "";
            // Write your logic here
