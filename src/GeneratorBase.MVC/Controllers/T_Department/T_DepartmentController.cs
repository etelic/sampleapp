...
{	
    public partial class T_DepartmentController : BaseController
    {
        ...
        {
	 ViewBag.T_DepartmentCodeCount = t_department.t_departmentcode.Count();
        }
...
[AcceptVerbs(HttpVerbs.Get)]
	...
	break;
		...
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetMandatoryProperties(T_Department OModel)
        {
		Dictionary<string, string> RequiredProperties = new Dictionary<string, string>();
		if(User.businessrules != null)
		{
        ...
        {
            var obj1 = db.T_Departments.Find(Id);
		...
		public bool CheckBeforeSave(T_Department t_department)
        {
            var result = true;
            // Write your logic here
