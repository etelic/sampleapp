...
{	
    ...
    {
		private void LoadViewDataForCount(T_EmployeeOrganizationAssociation t_employeeorganizationassociation, string AssocType)
        {
        }
		private void LoadViewDataAfterOnEdit(T_EmployeeOrganizationAssociation t_employeeorganizationassociation)
        {
					 ViewBag.T_EmployeeID = new SelectList(db.T_Employees, "ID", "DisplayValue", t_employeeorganizationassociation.T_EmployeeID);
			 ViewBag.T_OrganizationID = new SelectList(db.T_Organizations, "ID", "DisplayValue", t_employeeorganizationassociation.T_OrganizationID);
        }
        private void LoadViewDataBeforeOnEdit(T_EmployeeOrganizationAssociation t_employeeorganizationassociation)
        {
		
               var _objT_Employee = new List<T_Employee>();
               _objT_Employee.Add(t_employeeorganizationassociation.t_employee);
			   			   ViewBag.T_EmployeeID = new SelectList(_objT_Employee, "ID", "DisplayValue", t_employeeorganizationassociation.T_EmployeeID);
			               var _objT_Organization = new List<T_Organization>();
               _objT_Organization.Add(t_employeeorganizationassociation.t_organization);
			   			   ViewBag.T_OrganizationID = new SelectList(_objT_Organization, "ID", "DisplayValue", t_employeeorganizationassociation.T_OrganizationID);
			        }
        private void LoadViewDataAfterOnCreate(T_EmployeeOrganizationAssociation t_employeeorganizationassociation)
        {
			 ViewBag.T_EmployeeID = new SelectList(db.T_Employees, "ID", "DisplayValue", t_employeeorganizationassociation.T_EmployeeID);
			 ViewBag.T_OrganizationID = new SelectList(db.T_Organizations, "ID", "DisplayValue", t_employeeorganizationassociation.T_OrganizationID);
        }
        private void LoadViewDataBeforeOnCreate(string HostingEntityName, string HostingEntityID, string AssociatedType)
        {
			...
			if(HostingEntityName == "T_Employee" && Convert.ToInt64(HostingEntityID) > 0 && AssociatedType=="T_EmployeeOrganizationAssociation_T_Employee")
			{
            ...
            else
			{
								...
								//var T_EmployeeOrganizationAssociationlist = db.T_Employees.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
								//ViewBag.t_employeeorganizationassociation = new SelectList(T_EmployeeOrganizationAssociationlist, "ID", "DisplayValue");
						//ManytoOne association
						var T_AssociatedEmployeeTypelist = db.T_Employeetypes.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
						ViewBag.t_associatedemployeetype = new SelectList(T_AssociatedEmployeeTypelist, "ID", "DisplayValue");
						//ManytoOne association
						var T_AssociatedEmployeeStatuslist = db.T_Employeestatuss.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
				...
				long hostid = Convert.ToInt64(HostingEntityID);
                var Selectedlist = db.T_EmployeeOrganizationAssociations.Where(p => p.T_OrganizationID == hostid).Select(q => q.T_EmployeeID);
                //var AvailableList = db.T_Employees.Where(p => !Selectedlist.Contains(p.Id)).OrderBy(p => p.DisplayValue);
		var AvailableList = db.T_Employees.Where(p => !Selectedlist.Contains(p.Id)).OrderBy(p => p.DisplayValue);
                ViewBag.IsTop50 = "none";
				if (AvailableList.Count() > 50)
                    ViewBag.IsTop50 = "block";
				ViewBag.T_EmployeeIDAvailable  = new SelectList(AvailableList.Take(50).ToList(), "ID", "DisplayValue");
                ViewBag.T_EmployeeIDSelected = new MultiSelectList(db.T_Employees.Where(p => Selectedlist.Contains(p.Id)).OrderBy(p => p.DisplayValue).ToList(), "ID", "DisplayValue", Selectedlist);
		    }
			if(HostingEntityName == "T_Organization" && Convert.ToInt64(HostingEntityID) > 0 && AssociatedType=="T_EmployeeOrganizationAssociation_T_Organization")
			{
			    long hostid = Convert.ToInt64(HostingEntityID);
				ViewBag.T_OrganizationID = new SelectList(db.T_Organizations.Where(p=>p.Id==hostid).ToList(), "ID", "DisplayValue",HostingEntityID);
				ViewBag.DisplayVal = db.T_Organizations.Where(p => p.Id == hostid).ToList().FirstOrDefault().DisplayValue;
		    }
            else
			{

								//Manytomany associations
								//var T_EmployeeOrganizationAssociationlist = db.T_Organizations.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
								//ViewBag.t_employeeorganizationassociation = new SelectList(T_EmployeeOrganizationAssociationlist, "ID", "DisplayValue");

				long hostid = Convert.ToInt64(HostingEntityID);
                var Selectedlist = db.T_EmployeeOrganizationAssociations.Where(p => p.T_EmployeeID == hostid).Select(q => q.T_OrganizationID);
                //var AvailableList = db.T_Organizations.Where(p => !Selectedlist.Contains(p.Id)).OrderBy(p => p.DisplayValue);
		var AvailableList = db.T_Organizations.Where(p => !Selectedlist.Contains(p.Id)).OrderBy(p => p.DisplayValue);
                ViewBag.IsTop50 = "none";
				if (AvailableList.Count() > 50)
                    ViewBag.IsTop50 = "block";
				ViewBag.T_OrganizationIDAvailable  = new SelectList(AvailableList.Take(50).ToList(), "ID", "DisplayValue");
                ViewBag.T_OrganizationIDSelected = new MultiSelectList(db.T_Organizations.Where(p => Selectedlist.Contains(p.Id)).OrderBy(p => p.DisplayValue).ToList(), "ID", "DisplayValue", Selectedlist);
		    }
        }
		...
		private IQueryable<T_EmployeeOrganizationAssociation> sortRecords(IQueryable<T_EmployeeOrganizationAssociation> lstT_EmployeeOrganizationAssociation, string sortBy, string isAsc)
        {
            string methodName = "";
	 ...
	 if(sortBy == "T_EmployeeID")
                return isAsc.ToLower() == "asc" ? lstT_EmployeeOrganizationAssociation.OrderBy(p => p.t_employee.DisplayValue) : lstT_EmployeeOrganizationAssociation.OrderByDescending(p => p.t_employee.DisplayValue);
	 if(sortBy == "T_OrganizationID")
                return isAsc.ToLower() == "asc" ? lstT_EmployeeOrganizationAssociation.OrderBy(p => p.t_organization.DisplayValue) : lstT_EmployeeOrganizationAssociation.OrderByDescending(p => p.t_organization.DisplayValue);
            ParameterExpression paramExpression = Expression.Parameter(typeof(T_EmployeeOrganizationAssociation), "t_employeeorganizationassociation");
            MemberExpression memExp = Expression.PropertyOrField(paramExpression, sortBy);
            LambdaExpression lambda = Expression.Lambda(memExp, paramExpression);
            return (IQueryable<T_EmployeeOrganizationAssociation>)lstT_EmployeeOrganizationAssociation.Provider.CreateQuery(
                Expression.Call(
                    typeof(Queryable),
                    methodName,
                    new Type[] { lstT_EmployeeOrganizationAssociation.ElementType, lambda.Body.Type },
                    lstT_EmployeeOrganizationAssociation.Expression,
                    lambda));
        }
        ...
        public ActionResult SetFSearch(string searchString, string HostingEntity ,string t_employee,string t_organization, bool? RenderPartial)
        {
			...
			{
				ViewBag.t_employee = new SelectList(T_Employeelist, "ID", "DisplayValue");
			}
			var T_Organizationlist = db.T_Organizations.OrderBy(p=>p.DisplayValue).Take(10).Distinct();
            if (t_organization != null)
            {
                var ids = t_organization.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
				 ViewBag.SearchResult += "\r\n Organization= ";
				   ...
				   foreach (var str in ids)
					...
					ids1 = ids1.ToList();
					var list = T_Organizationlist.Union(db.T_Organizations.Where(p=>ids1.Contains(p.Id))).Distinct();
					ViewBag.t_organization = new SelectList(list, "ID", "DisplayValue");
			}
			else
			{
				ViewBag.t_organization = new SelectList(T_Organizationlist, "ID", "DisplayValue");
			}
			}
			else
			{
			...
			var objT_Organization = new List<T_Organization>();
		    ViewBag.t_organization = new SelectList(objT_Organization, "ID", "DisplayValue");
			}
				...
				ViewBag.EntityName = "T_EmployeeOrganizationAssociation";
			...
			columns.Add("3", "Organization");
				ViewBag.HideColumns = new MultiSelectList(columns, "Key", "Value");
				if ((RenderPartial == null ? false : RenderPartial.Value))
					return PartialView("~/Views/T_EmployeeOrganizationAssociation/CustomReportSearch.cshtml", new T_EmployeeOrganizationAssociation());
				return View(new T_EmployeeOrganizationAssociation());
            }

		public string conditionFSearch(string property, string operators, string value)
        {
            string expression = string.Empty;
            var PrpertyType = GetDataTypeOfProperty("T_EmployeeOrganizationAssociation", property);
            var dataType = PrpertyType[0];
            property = PrpertyType[1];
            if (value.StartsWith("[") && value.EndsWith("]"))
            {
                var ValueType = GetDataTypeOfProperty("T_EmployeeOrganizationAssociation", value, true);
		...
		// GET: /T_EmployeeOrganizationAssociation/FSearch/
		public ActionResult FSearch(string currentFilter, string searchString, string FSFilter, string sortBy, string isAsc, int? page, int? itemsPerPage, string search, bool? IsExport ,string t_employee,string t_organization , string FilterCondition, string HostingEntity, string AssociatedType,string HostingEntityID, string viewtype, string SortOrder, string HideColumns, string GroupByColumn,bool? IsReports)
        {
            ...
            {
                lstT_EmployeeOrganizationAssociation  = searchRecords(lstT_EmployeeOrganizationAssociation, searchString.ToUpper(),true);
            }
			  if(!string.IsNullOrEmpty(search))
                	search=search.Replace("?IsAddPop=true", "");
			if(!string.IsNullOrEmpty(search)){
				ViewBag.SearchResult += "\r\n General Criterial= "+search;
				lstT_EmployeeOrganizationAssociation = searchRecords(lstT_EmployeeOrganizationAssociation, search,true);
			}
			...
			lstT_EmployeeOrganizationAssociation = lstT_EmployeeOrganizationAssociation.Include(t=>t.t_employee).Include(t=>t.t_organization);
			lstT_EmployeeOrganizationAssociation = Sorting.Sort<T_EmployeeOrganizationAssociation>(lstT_EmployeeOrganizationAssociation, SortOrder);
			...
			if (!string.IsNullOrEmpty(FilterCondition))
            {
                ...
                foreach (var cond in conditions)
                {
                    ...
                    ViewBag.SearchResult += " " + GetPropertyDP("T_EmployeeOrganizationAssociation", PropertyName) + " " + Operator + " " + Value + " " + LogicalConnector;
                    iCnt++;
                }
                if (!string.IsNullOrEmpty(whereCondition.ToString()))
                    lstT_EmployeeOrganizationAssociation = lstT_EmployeeOrganizationAssociation.Where(whereCondition.ToString());
			 ...
			 if (!string.IsNullOrEmpty(GroupByColumn))
            {
                ...
                foreach (string prop in props)
                {
                    ...
                    var asso = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_EmployeeOrganizationAssociation").Associations.FirstOrDefault(p => p.AssociationProperty == prop);
                    if (asso != null)
                    {
                        columns.Add(prop);
                        if (iCnt == 1)
                ...
                var grp_T_EmployeeOrganizationAssociation = lstT_EmployeeOrganizationAssociation;
                var grp_T_EmployeeOrganizationAssociationList = grp_T_EmployeeOrganizationAssociation.GroupByMany(groupcolumn);
                var objT_EmployeeOrganizationAssociationList = new List<T_EmployeeOrganizationAssociation>();

                foreach (var grp in grp_T_EmployeeOrganizationAssociationList)
                {
                    ...
                    if (Subgroup != null && Subgroup.Count() > 0)
                    {
                        foreach (var itemsub in Subgroup)
                        {
                            ...
                            {
                                var objT_EmployeeOrganizationAssociation = new T_EmployeeOrganizationAssociation();
                                objT_EmployeeOrganizationAssociation = (T_EmployeeOrganizationAssociation)item1;
                                objT_EmployeeOrganizationAssociation.m_DisplayValue = SecondKey;
                                objT_EmployeeOrganizationAssociationList.Add(objT_EmployeeOrganizationAssociation);
                            }
                        }
                    }
                    else
                    {
                        ...
                        {
                            var objT_EmployeeOrganizationAssociation = new T_EmployeeOrganizationAssociation();
                            objT_EmployeeOrganizationAssociation = (T_EmployeeOrganizationAssociation)itemgrp;
                            objT_EmployeeOrganizationAssociation.m_DisplayValue = firstKey.ToString();
                            objT_EmployeeOrganizationAssociationList.Add(objT_EmployeeOrganizationAssociation);
                        }
                    }
                }
				if (objT_EmployeeOrganizationAssociationList.Count() > 0)
                lstT_EmployeeOrganizationAssociation = objT_EmployeeOrganizationAssociationList.AsQueryable();
            ...
            var _T_EmployeeOrganizationAssociation = lstT_EmployeeOrganizationAssociation;
			//if (lstT_EmployeeOrganizationAssociation.Where(p => p.t_employee != null).Count() <= 50)
		    //ViewBag.t_employee = new SelectList(lstT_EmployeeOrganizationAssociation.Where(p => p.t_employee != null).Select(P => P.t_employee).Distinct(), "ID", "DisplayValue");
            if (t_employee != null)
            {
                var ids = t_employee.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
                ...
                ids1 = ids1.ToList();
                _T_EmployeeOrganizationAssociation = _T_EmployeeOrganizationAssociation.Where(p => ids1.Contains(p.T_EmployeeID));
            }
				//if (lstT_EmployeeOrganizationAssociation.Where(p => p.t_organization != null).Count() <= 50)
		    //ViewBag.t_organization = new SelectList(lstT_EmployeeOrganizationAssociation.Where(p => p.t_organization != null).Select(P => P.t_organization).Distinct(), "ID", "DisplayValue");
            if (t_organization != null)
            {
                var ids = t_organization.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
				 ...
				 foreach (var str in ids)
                {
                    ...
                    if (!string.IsNullOrEmpty(str))
                    {
                        ...
                        {
                            ids1.Add(Convert.ToInt64(str));
                            var obj = db.T_Organizations.Find(Convert.ToInt64(str));
                            ViewBag.SearchResult += obj != null ? obj.DisplayValue + ", " : "";
                        }
                ...
                ids1 = ids1.ToList();
                _T_EmployeeOrganizationAssociation = _T_EmployeeOrganizationAssociation.Where(p => ids1.Contains(p.T_OrganizationID));
            }
				if (!string.IsNullOrEmpty(SortOrder))
            {
                ...
                var Entity = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_EmployeeOrganizationAssociation");
           ...
           // return View("Index", _T_EmployeeOrganizationAssociation.ToPagedList(pageNumber, pageSize));
		    if (IsReports != null)
            {
			  var lstCustReportItem = db.FavoriteItems.Where(p => p.LastUpdatedByUser == User.Name);
                ...
                return PartialView("~/Views/T_EmployeeOrganizationAssociation/CustomReportResult.cshtml", _T_EmployeeOrganizationAssociation.ToPagedList(pageNumber, pageSize));
            }
        ...
        {
		string result = "";
		var entity = "T_EmployeeOrganizationAssociation";
           ...
           var entitylist = db.T_EmployeeOrganizationAssociations;
		...
		public string ShowGraph1(string type, int? inlarge)
        {
            string result = "";
           {
                var gd = db.T_EmployeeOrganizationAssociations.GroupBy(p => p.t_employee.DisplayValue).ToList();
			   ...
			   var chart = new System.Web.UI.DataVisualization.Charting.Chart
                ...
                chart.ChartAreas.Add(CreateChartArea(SeriesChartType.Column, "", "Employee", "EmployeeOrganizationAssociation"));
                ...
                if (cntgrt10)
                    {
                        string img = "<div class='col-sm-4' style='padding:0px; margin:0px 0px 0px 0px;'><img src='data:image/png;base64,{0}' alt='' usemap='#ImageMap' style='width:100%; cursor: pointer;' " + (inlarge == null ? "data-toggle='modal' data-target='#dvPopupBulkOperation' onclick=\"OpenPopUpGraph('PopupBulkOperation','dvPopupBulkOperation','" + Url.Action("ShowGraph", "T_EmployeeOrganizationAssociation", new { type = "1", inlarge = 1 }) + "')\"" : "") + "/></div>";
                        string encoded = Convert.ToBase64String(bytes.ToArray());
                        result += String.Format(img, encoded);
                    }
                    else
           ...
           {
                var gd = db.T_EmployeeOrganizationAssociations.GroupBy(p => p.t_organization.DisplayValue).ToList();
                var _xval = gd.Select(k => Convert.ToString(k.Key)).ToList();
			   ...
			   var chart = new System.Web.UI.DataVisualization.Charting.Chart
                ...
                chart.BorderSkin.SkinStyle = BorderSkinStyle.Emboss;
				if (cntgrt10)
                chart.Titles.Add(CreateTitle("Count by Organization (Top 10)"));
				else
				 chart.Titles.Add(CreateTitle("Count by Organization"));
                chart.ChartAreas.Add(CreateChartArea(SeriesChartType.Pie, "", "Organization", "EmployeeOrganizationAssociation"));
                ...
                if (cntgrt10)
                    {
                        string img = "<div class='col-sm-4' style='padding:0px; margin:0px 0px 0px 0px;'><img src='data:image/png;base64,{0}' alt='' usemap='#ImageMap' style='width:100%; cursor: pointer;' " + (inlarge == null ? "data-toggle='modal' data-target='#dvPopupBulkOperation' onclick=\"OpenPopUpGraph('PopupBulkOperation','dvPopupBulkOperation','" + Url.Action("ShowGraph", "T_EmployeeOrganizationAssociation", new { type = "2", inlarge = 1 }) + "')\"" : "") + "/></div>";
                        string encoded = Convert.ToBase64String(bytes.ToArray());
                        result += String.Format(img, encoded);
                    }
                    else
        ...
        public string GetDisplayValue(string id)
        {
            ...
            var _Obj = db1.T_EmployeeOrganizationAssociations.FirstOrDefault(p => p.Id == idvalue);
		 ...
		 public object GetRecordById(string id)
        {
		            ApplicationContext db1 = new ApplicationContext(new SystemUser());
            if (string.IsNullOrEmpty(id)) return "";
            var _Obj = db1.T_EmployeeOrganizationAssociations.Find(Convert.ToInt64(id));
            return _Obj;
        }
		public string GetRecordById_Reflection(string id)
        {
			...
			if (string.IsNullOrEmpty(id)) return "";
			var _Obj = db1.T_EmployeeOrganizationAssociations.Find(Convert.ToInt64(id));
            return _Obj == null ? "" : EntityComparer.EnumeratePropertyValues<T_EmployeeOrganizationAssociation>(_Obj, "T_EmployeeOrganizationAssociation", new string[] { ""  }); ;
			        }
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetAllValueForFilter(string key, string AssoNameWithParent, string AssociationID, string ExtraVal)
        {
		            IQueryable<T_EmployeeOrganizationAssociation> list = db.T_EmployeeOrganizationAssociations;
		...
		public JsonResult GetAllValue(string caller, string key, string AssoNameWithParent, string AssociationID, string ExtraVal)
        {
            ...
            if (AssoNameWithParent != null && !string.IsNullOrEmpty(AssociationID))
            {
                ...
                {
                    IQueryable query = db.T_EmployeeOrganizationAssociations;
					string lambda = "";
                   ...
                   // ParameterExpression p = Expression.Parameter(typeof(T_EmployeeOrganizationAssociation), "p");
                   // MemberExpression member = Expression.PropertyOrField(p, propToWhere);
                   // LambdaExpression lambda = Expression.Lambda<Func<T_EmployeeOrganizationAssociation, bool>>(Expression.Equal(member, Expression.Convert(Expression.Constant(AssoID), member.Type)), p);
                   // MethodCallExpression methodCall = Expression.Call(typeof(Queryable), "Where", exprArgTypes, query.Expression, lambda);
                   // IQueryable q = query.Provider.CreateQuery(methodCall);
                   //list = ((IQueryable<T_EmployeeOrganizationAssociation>)q);
				   list = ((IQueryable<T_EmployeeOrganizationAssociation>)query);
                }
				else if (AssoID == 0)
                {
                   IQueryable query = db.T_EmployeeOrganizationAssociations;
            ...
            list = _fad.FilterDropdown<T_EmployeeOrganizationAssociation>(User,list, "T_EmployeeOrganizationAssociation",caller);
        ...
        public JsonResult GetAllValues(string SearchString, string HostingEntityName, string HostingEntityID, string AssociatedType, string size)
        {
            ...
            {
                var Selectedlist = db.T_EmployeeOrganizationAssociations.Where(p => p.T_EmployeeID == hostid).Select(q => q.T_OrganizationID);
				//var Finallist = db.T_Organizations.Where(p => !Selectedlist.Contains(p.Id) && (p.DisplayValue.Contains(SearchString))).OrderBy(p => p.DisplayValue);
				 
				
		var Finallist = db.T_Organizations.Where(p => !Selectedlist.Contains(p.Id)).ToList();
            ...
            if (HostingEntityName == "T_Organization")
            {
                var Selectedlist = db.T_EmployeeOrganizationAssociations.Where(p => p.T_OrganizationID == hostid).Select(q => q.T_EmployeeID);
				//var Finallist = db.T_Employees.Where(p => !Selectedlist.Contains(p.Id) && (p.DisplayValue.Contains(SearchString))).OrderBy(p => p.DisplayValue);
		var Finallist = db.T_Employees.Where(p => !Selectedlist.Contains(p.Id)).ToList();
		...
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetAllValues1(string SearchString, string HostingEntityName, string HostingEntityID, string AssociatedType, string size , string t_associatedemployeetype,string t_associatedemployeestatus,string t_employeeaddress  )
        {
			long hostid = Convert.ToInt64(HostingEntityID);
			int pagesize = 50;
			if (HostingEntityName == "T_Employee")
		...
		var Finallist = db.T_Employees.Where(p => !Selectedlist.Contains(p.Id)).ToList();
				...
				if (t_associatedemployeetype != null)
                {
                    ...
                    ids1 = ids1.ToList();
                    Finallist = Finallist.Where(p => ids1.Contains(p.T_AssociatedEmployeeTypeID)).ToList();
                }
				if (t_associatedemployeestatus != null)
                {
                    ...
                    ids1 = ids1.ToList();
                    Finallist = Finallist.Where(p => ids1.Contains(p.T_AssociatedEmployeeStatusID)).ToList();
                }
...
[AcceptVerbs(HttpVerbs.Get)]
            ...
            if (AssoNameWithParent != null && !string.IsNullOrEmpty(AssociationID))
            {
				try
                {
					...
					if (AssoID != null && AssoID > 0)
					{
						...
						MethodCallExpression methodCall = Expression.Call(typeof(Queryable), "Where", exprArgTypes, query.Expression, lambda);
						IQueryable q = query.Provider.CreateQuery(methodCall);
						list = ((IQueryable<T_EmployeeOrganizationAssociation>)q).Take(20);
					}
				}
				catch
                {
        ...
        public JsonResult GetAllMultiSelectValueForBR(string propNameBR)
        {
            ...
            if (!string.IsNullOrEmpty(propNameBR))
            {
                ...
                ParameterExpression param = Expression.Parameter(typeof(T_EmployeeOrganizationAssociation), "d");
                //bulid expression tree:data.Field1
                var Property = typeof(T_EmployeeOrganizationAssociation).GetProperty(propNameBR);
                ...
                if (targetType.GetGenericArguments().Count() > 0)
                {
                    if (targetType.GetGenericArguments()[0].Name == "DateTime")
                    {
                        ...
                        new Type[] { typeof(T_EmployeeOrganizationAssociation), typeof(DateTime?) }, Expression.Constant(list.AsQueryable()), pred);
                ...
                if (targetType.IsGenericType && targetType.GetGenericTypeDefinition() == typeof(Nullable<>))
                {
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_EmployeeOrganizationAssociation), typeof(decimal?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_EmployeeOrganizationAssociation), typeof(bool?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_EmployeeOrganizationAssociation), typeof(Int32?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_EmployeeOrganizationAssociation), typeof(Int64?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_EmployeeOrganizationAssociation), typeof(double?) }, Expression.Constant(list.AsQueryable()), pred);
                ...
                {
                    Expression expr = Expression.Call(typeof(Queryable), "Select",
                            new Type[] { typeof(T_EmployeeOrganizationAssociation), typeof(string) }, Expression.Constant(list.AsQueryable()), pred);
        ...
        public JsonResult GetAllMultiSelectValue(string key, string AssoNameWithParent, string AssociationID)
        {
            ...
            if (AssoNameWithParent != null && !string.IsNullOrEmpty(AssociationID))
            {
                ...
                paramList.Add(Expression.Parameter(typeof(T_EmployeeOrganizationAssociation), "p"));
        ...
        {
            //ViewBag.IsMapping = (db.ImportConfigurations.Where(p => p.Name == "T_EmployeeOrganizationAssociation")).Count() > 0 ? true : false;
            var lstMappings = db.ImportConfigurations.Where(p => p.Name == "T_EmployeeOrganizationAssociation").ToList();
         ...
         public ActionResult Upload([Bind(Include = "FileUpload")] HttpPostedFileBase FileUpload, FormCollection collection)
        {
            if (FileUpload != null)
            {
                ...
                if (fileExtension == ".xls" || fileExtension == ".xlsx" || fileExtension == ".csv" || fileExtension == ".all")
                {
                    ...
                    var entList = GeneratorBase.MVC.ModelReflector.Entities.FirstOrDefault(e => e.Name == "T_EmployeeOrganizationAssociation");
                    if (entList != null)
                    {
					...
					if (!string.IsNullOrEmpty(collection["ListOfMappings"]))
                    {
                        ...
                        string colDisKey = "";
                        string colListInx = "";
                        typeName = "T_EmployeeOrganizationAssociation";
                        ...
                        {
                            var lstMapping = db.ImportConfigurations.Where(p => p.Name == "T_EmployeeOrganizationAssociation" && p.IsDefaultMapping);
                        ...
                        DetailMessage = "We have received " + objDataSet.Tables[0].Rows.Count + " new EmployeeOrganizationAssociations";
                            ...
                            foreach (var association in entList.Associations)
                            {
                                ...
                                for (int i = 0; i < uniqueCols.Rows.Count; i++)
                                {
                                    ...
                                    switch (association.AssociationProperty)
                                    {
										 ...
										 break;
																		 case "T_OrganizationID":
										 var t_organizationId = db.T_Organizations.FirstOrDefault(p => p.DisplayValue == assovalue);
										 if (t_organizationId == null)
											uniqueassoValues.Add(assovalue);
										 break;
								                                        default:
                                            break;
        ...
        public ActionResult ConfirmImportData(FormCollection collection)
        {
            ...
            string excelConnectionString = string.Empty;
			string typename = "T_EmployeeOrganizationAssociation";
                    ...
                    foreach (var association in entList.Associations)
                    {
                        ...
                        for (int i = 0; i < uniqueCols.Rows.Count; i++)
                        {
                            ...
                            switch (association.AssociationProperty)
                            {
										 ...
										 break;
																		 case "T_OrganizationID":
										 var strPropertyT_Organization = lstEntityProp.FirstOrDefault(p => p.Key == "T_OrganizationID").Value;
										 ModelReflector.Property propT_Organization = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_Organization").Properties.FirstOrDefault(p => p.DisplayName == strPropertyT_Organization);
										 //var elementTypeT_Organization = db.T_Organizations.ElementType;
										 //var propertyInfoT_Organization = elementTypeT_Organization.GetProperty(propT_Organization.Name);
										 // var t_organizationId = db.T_Organizations.AsEnumerable().FirstOrDefault(p => Convert.ToString(propertyInfoT_Organization.GetValue(p, null)) == assovalue);
										 var t_organizationId = db.T_Organizations.Where(propT_Organization.Name+"=\""+assovalue+"\"").FirstOrDefault();
										 if (t_organizationId == null)
											uniqueassoValues.Add(assovalue);
										 break;
								                                default:
        ...
        public ActionResult ImportData(FormCollection collection)
        {
            ...
            if (fileExtension == ".xls" || fileExtension == ".xlsx" || fileExtension == ".csv")
            {
                ...
                if (selectedlist != null && columnlist != null)
                {
                    for (int i = 0; i < objDataSet.Tables[0].Rows.Count; i++)
                    {
                        ...
                        if (AreAllColumnsEmpty(objDataSet.Tables[0].Rows[i], sheetColumns))
                            continue;
                        T_EmployeeOrganizationAssociation model = new T_EmployeeOrganizationAssociation();
		  ...
		  else
			{
				if ((collection["T_EmployeeID"].ToString() == "true,false"))
				{
					try
					{
						...
						objT_Employee.T_FirstName  = (columnValue);
		 ...
		 if(lstEntityProp.Count > 0)
		 {
			 ...
			 //var elementTypeT_Organization = db.T_Organizations.ElementType;
			 //var propertyInfoT_Organization = elementTypeT_Organization.GetProperty(propT_Organization.Name);			 
			 //t_organizationId = db.T_Organizations.AsEnumerable().FirstOrDefault(p => Convert.ToString(propertyInfoT_Organization.GetValue(p, null)) == columnValue);
			 t_organizationId = db.T_Organizations.Where(propT_Organization.Name + "=\"" + columnValue + "\"").FirstOrDefault();
		 }
		 else
			t_organizationId = db.T_Organizations.FirstOrDefault(p=>p.DisplayValue == columnValue);
		 if (t_organizationId != null)
			model.T_OrganizationID = t_organizationId.Id;
		  else
			{
				if ((collection["T_OrganizationID"].ToString() == "true,false"))
				{
					try
					{
						T_Organization objT_Organization = new T_Organization();
						objT_Organization.T_Name  = (columnValue);
						db.T_Organizations.Add(objT_Organization);
						db.SaveChanges();
						model.T_OrganizationID = objT_Organization.Id;
					}
					catch
					{
						continue;
            ...
            default:
                break;
					    ...
					    if (ValidateModel(model) && string.IsNullOrEmpty(CheckBeforeSave(model)))
                        {
                            ...
                            {
								db.T_EmployeeOrganizationAssociations.Add(model);
								db.SaveChanges();
							}
							else
                            {
		...
		public bool ValidateModel(T_EmployeeOrganizationAssociation validate)
        {
		...
		public object GetFieldValueByEntityId(long Id, string PropName)
        {
            ...
            {
			                ApplicationContext db1 = new ApplicationContext(new SystemUser());
                var obj1 = db1.T_EmployeeOrganizationAssociations.Find(Id);
		...
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetReadOnlyProperties(T_EmployeeOrganizationAssociation OModel)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            if (User.businessrules != null)
            {
                var BR = User.businessrules.Where(p => p.EntityName == "T_EmployeeOrganizationAssociation").ToList();
                var BRAll = BR;
                if (BR != null && BR.Count > 0)
                {
                    var ResultOfBusinessRules = db.ReadOnlyPropertiesRule(OModel, BR, "T_EmployeeOrganizationAssociation");
        ...
        [AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetMandatoryProperties(T_EmployeeOrganizationAssociation OModel, string ruleType)
        {
            ...
            if (User.businessrules != null)
            {
                ...
                if (BR != null && BR.Count > 0)
                {
                    ...
                    var ResultOfBusinessRules = db.MandatoryPropertiesRule(OModel, BR, "T_EmployeeOrganizationAssociation");
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
        ...
        [AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetValidateBeforeSaveProperties(T_EmployeeOrganizationAssociation OModel, string ruleType)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            var conditions = "";
            if (User.businessrules != null)
            {
                ...
                if (BR != null && BR.Count > 0)
                {
                    var ResultOfBusinessRules = db.ValidateBeforeSavePropertiesRule(OModel, BR, "T_EmployeeOrganizationAssociation");
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
        ...
        [AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetLockBusinessRules(T_EmployeeOrganizationAssociation OModel)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            //string RulesApplied = "";
            if (User.businessrules != null)
            {
                ...
                if (BR != null && BR.Count > 0)
                {
                    var ResultOfBusinessRules = db.LockEntityRule(OModel, BR, "T_EmployeeOrganizationAssociation");
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
		...
		private List<string> CheckMandatoryProperties(T_EmployeeOrganizationAssociation OModel)
        {
                ...
                if (BR != null && BR.Count > 0)
                {
                    ...
                    if (ResultOfBusinessRules.Keys.Select(p=>p.TypeNo).Contains(2))
                    {
                        ...
                        foreach (string paramName in Args.Select(p => p.ParameterName))
                        {
                            ...
                            {
                                var dispName = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_EmployeeOrganizationAssociation").Properties.FirstOrDefault(p => p.Name == paramName).DisplayName;
                                result.Add(dispName);
                            }
                        }
                    }
		...
		public long? GetIdFromDisplayValue(string displayvalue)
        {
            ...
            var _Obj = db1.T_EmployeeOrganizationAssociations.FirstOrDefault(p => p.DisplayValue == displayvalue);
            long outValue;
            if (_Obj != null)
        ...
        {
            ApplicationContext db1 = new ApplicationContext(new SystemUser());
            IQueryable query = db1.T_EmployeeOrganizationAssociations;
            Type[] exprArgTypes = { query.ElementType };
            ...
            lambda = Expression.Lambda<Func<T_EmployeeOrganizationAssociation, bool>>(Expression.Equal(member, Expression.Convert(Expression.Constant(PropValue), member.Type)), p);
            else
                lambda = Expression.Lambda<Func<T_EmployeeOrganizationAssociation, bool>>(Expression.Equal(member, Expression.Constant(null, member.Type)), p);
            MethodCallExpression methodCall = Expression.Call(typeof(Queryable), "Where", exprArgTypes, query.Expression, lambda);
            IQueryable q = query.Provider.CreateQuery(methodCall);
            long outValue;
            var list1 = ((IQueryable<T_EmployeeOrganizationAssociation>)q);
		...
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult Check1MThresholdValue(T_EmployeeOrganizationAssociation t_employeeorganizationassociation)
        {
            Dictionary<string, string> msgThreshold = new Dictionary<string, string>();
            return Json(msgThreshold, JsonRequestBehavior.AllowGet);
        }
		public bool CheckBeforeDelete(T_EmployeeOrganizationAssociation t_employeeorganizationassociation)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_EmployeeOrganizationAssociation t_employeeorganizationassociation)
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_EmployeeOrganizationAssociation t_employeeorganizationassociation)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_EmployeeOrganizationAssociation t_employeeorganizationassociation, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_EmployeeOrganizationAssociation t_employeeorganizationassociation)
        {
        ...
        public ActionResult GetCalculationValues(T_EmployeeOrganizationAssociation t_employeeorganizationassociation)
        {
            t_employeeorganizationassociation.setCalculation();
            Dictionary<string, string> Calculations = new Dictionary<string, string>();
            System.Reflection.PropertyInfo[] properties = (t_employeeorganizationassociation.GetType()).GetProperties().Where(p => p.PropertyType.FullName.StartsWith("System")).ToArray();
        ...
        public void GetTemplatesForList(string defaultview)
        {
            ...
            var lstDefaultEntityPage = from s in db.DefaultEntityPages
                                       where s.EntityName == "T_EmployeeOrganizationAssociation"
                                       select s;
	...
	[HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult GetDerivedDetails(T_EmployeeOrganizationAssociation t_employeeorganizationassociation, string IgnoreEditable)
        {
		...
		[HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult GetDerivedDetailsInline(string host, string value, T_EmployeeOrganizationAssociation t_employeeorganizationassociation, string IgnoreEditable)
        {
            Dictionary<string, string> derivedlist = new Dictionary<string, string>();
            return Json(derivedlist, "application/json", System.Text.Encoding.UTF8, JsonRequestBehavior.AllowGet);
        }
