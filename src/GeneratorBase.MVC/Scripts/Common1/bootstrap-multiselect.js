...
!function ($) {
    ...
    Multiselect.prototype = {
        ...
        getfiltervalues: function (obj, e) {
            ...
            //var oldele = document.getElementById(hostingid);
            //var oldValue = "";
            //if (oldele != null) {
            //    for (var o = 0; o < oldele.options.length; o++) {
            //        if (oldele.options[o].selected) {
            //            if (oldValue == "")
            //                oldValue = oldele.options[o].value;
            //            else
            //                oldValue += "," + oldele.options[o].value;
            //        }
            //    }
        ...
        dataproviderOnShowDropDown: function (dataprovider, url) {
            //var urlGetAll = $("#" + url).attr("dataurl").replace("GetAllMultiSelectValue", "Index") + "?BulkOperation=true";
	    var urlGetAll = $("#" + url).attr("dataurl").replace("GetAllMultiSelectValue", "Index");// + "?BulkOperation=single";
            urlGetAll = addParameterToURL(urlGetAll, 'BulkOperation', 'true');
            var optionDOM = "";
            for (var i = 0; i < dataprovider.length; i++) {
                optionDOM += '<option value="' + dataprovider[i].Id + '">' + dataprovider[i].Name + '</option>';
            }
            ...
            if ($(optionDOM).length >= 10) {
                ...
                var getall = "<li class='disabled-result disabled-result' style='font-style:Italic;' >"+link+"</li>";
                this.$ul.append($(getall));
            }
        },
        //function call on enter value in searchable text box
        dataproviderOnFilter: function (dataprovider) {
            var optionDOM = "";
            for (var i = 0; i < dataprovider.length; i++) {
